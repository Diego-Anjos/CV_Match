      ...
      >
        <div className="p-8 sm:p-10">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-display font-bold text-slate-900 tracking-tight">CV Match</h1>
            ...
            {isRecoveringPassword ? (
                ...
                {recoverySuccess ? (
                  ...
                  >
                    ...
                    <p className="text-slate-700 font-medium">
                      ...
                      <span className="text-slate-500 font-normal text-sm">Verifique sua caixa de entrada.</span>
                    </p>
                  </motion.div>
                ) : (
                  <form className="space-y-5" onSubmit={handleRecoverySubmit}>
                    ...
                    <button
                      ...
                      className="w-full py-2 text-sm text-slate-500 hover:text-emerald-600 transition-colors flex items-center justify-center gap-1"
                    >
              ...
              >
                ...
                <div className="mt-8">
                  ...
                  <button className="mt-6 w-full py-3 px-4 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-medium rounded-xl transition-colors flex items-center justify-center gap-3">
        ...
        {!isRecoveringPassword && (
          <div className="bg-slate-50 p-6 text-center border-t border-slate-100">
            <p className="text-sm text-slate-600">
              ...
              <Link href="/cadastro" className="font-bold text-emerald-600 hover:text-emerald-500 transition-colors">
                Criar conta
              </Link>
            </p>
          </div>
